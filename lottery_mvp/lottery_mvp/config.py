...
DEFAULT_FREE_DAILY_AI_LIMIT = int(os.getenv("FREE_DAILY_AI_LIMIT", "3"))
DEFAULT_PAID_DAILY_AI_LIMIT = int(os.getenv("PAID_DAILY_AI_LIMIT", "10"))
DEFAULT_ACCESS_CODE_DAYS = int(os.getenv("DEFAULT_ACCESS_CODE_DAYS", "30"))
DEFAULT_PAID_ALLOWED_COUNT = int(os.getenv("DEFAULT_PAID_ALLOWED_COUNT", "3"))
DEFAULT_PAID_ALLOWED_TYPES = os.getenv("DEFAULT_PAID_ALLOWED_TYPES", "ssq,dlt,fc3d").split(",")
